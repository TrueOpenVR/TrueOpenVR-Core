...
- Поддержка контроллеров (Razer Hydra, PS Move, Oculus Touch, Daydream, Gear VR), а также разработка и поддержка контроллера ("Arduino + светящиеся шарики для пинг понга + датчики вращения + веб-камера" or "светящиеся шарики для пинг понга + Daydream контроллеры + веб-камера").
