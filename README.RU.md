...
- Добавить поддержку контроллеров в SteamVR драйвер.

- Поддержка трекеров (светящихся шариков для пинг понга и так далее) для самодельного VR.

- Разработка и поддержка контроллера ("Arduino + светящиеся шарики для пинг понга + датчики вращения + веб-камера" or "светящиеся шарики для пинг понга + Daydream контроллеры + веб-камера"). Инструкции по созданию.
