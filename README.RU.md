...
- Полная поддержка контроллеров ("Arduino + светящиеся шарики для пинг понга + датчики вращения + PS3 eye камера" or "светящиеся шарики для пинг понга + Daydream контроллеры + PS3 eye камера"). Инструкции по созданию.
